...
const jwt = require('express-jwt');  // Import express-jwt correctly for version 5.3.3
...
router
  ...
  .put(auth, tripsController.tripsUpdateTrip); // Only authenticated users can update trips
